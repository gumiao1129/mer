...
if(isset($_SESSION['patient_id']))
{
       ...
       if(isset($_POST["add_cate"])&&isset($_POST["add_id"]))
       {
           ...
           if($add_cate=="physician")
           {
                ...
                {
                    $columns = "patient_id_one, physician_id_one, require_to, date_created, status";
                    $content = "'$patient_id', '$add_id', '$add_cate', NOW(), 0";
           ...
           else if($add_cate=="patient")
           {
                ...
                else
                {
                    ...
                    $columns = "patient_id_one, patient_id_two, date_created, status";
                    $content = "'$patient_id','$add_id', NOW(), 0";
                    $model->dbinsert($table, $columns, $content);
    ...
    if(isset($_SESSION['physician_id']))
    {
       ...
       if(isset($_POST["add_cate"])&&isset($_POST["add_id"]))
       {
           ...
           if($add_cate=="patient")
           {
                ...
                {
                    $columns = "patient_id_one, physician_id_one, require_to, date_created, status";
                    $content = "'$add_id', '$physician_id', '$add_cate', NOW(), 0";
                    $model->dbinsert($table, $columns, $content);
           ...
           else if($add_cate=="physician")
           {
                ...
                {
                    $columns = "physician_id_one, physician_id_two, date_created, status";
                    $content = "'$physician_id','$add_id', NOW(), 0";
                    $model->dbinsert($table, $columns, $content);
