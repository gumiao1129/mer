...
function read_unread($BlockName,&$CurrRec,$RecNum){
        $CurrRec['level'] = "";
    $CurrRec['message_details'] = "message_details_sent.php?width=400&modal=true&profile_img=$CurrRec[thumbnail_pic_name]&firstname=$CurrRec[firstname]&lastname=$CurrRec[lastname]&message_id=$CurrRec[message_id]&message_recipient_id=$CurrRec[id]";
} 
