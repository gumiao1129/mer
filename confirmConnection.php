...
if(isset($_GET["profile_img"])&&isset($_GET["firstname"])&&isset($_GET["lastname"])&&isset($_GET["id"])&&isset($_GET["add_cate"]))
{
    ...
    if(isset($_SESSION['physician_id']))
    {
        if($add_cate=="patient")
        {
            $insert_des = $lang_confirm_des.$firstname.' '.$lastname. $lang_insert_des_pa; 
        }
        if($add_cate=="physician")
        {
            $insert_des = $lang_confirm_des.$firstname.' '.$lastname. $lang_insert_des_fr; 
        }
    }
    ...
    if(isset($_SESSION['patient_id']))
    {
        ...
        if($add_cate=="physician")
        {
            $insert_des = $lang_confirm_des.$firstname.' '.$lastname. $lang_insert_des_dr;
        }
    }

//Go to home page
            $template 		= "views/confirm_connection_tag.html";
